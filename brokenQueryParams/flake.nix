        ...
        override = pkgs_: {
          overrides = self: super:
            let modify = drv: pkgs.lib.pipe drv [ dontBenchmark dontCheck ]; in
            {
              ...
              servant-docs = super.callCabal2nix "servant-docs" "${inputs.servant.outPath}/servant-docs" { };
              servant = super.callCabal2nix "servant" "${inputs.servant.outPath}/servant" { };
              servant-server = super.callCabal2nix "servant-server" "${inputs.servant.outPath}/servant-server" { inherit (self) servant; };
              servant-client-core = super.callCabal2nix "servant-client-core" "${inputs.servant.outPath}/servant-client-core" { };
              servant-client = dontCheck (super.callCabal2nix "servant-client" "${inputs.servant.outPath}/servant-client" { inherit (self) servant; });
            } //
            (
              let
